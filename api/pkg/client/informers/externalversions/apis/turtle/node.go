	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TurtleTurtle().Nodes().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TurtleTurtle().Nodes().Watch(options)
			},
		},
		&apisturtle.Node{},
		resyncPeriod,
...
func (f *nodeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisturtle.Node{}, f.defaultInformer)
}

func (f *nodeInformer) Lister() turtle.NodeLister {
	return turtle.NewNodeLister(f.Informer().GetIndexer())
}
