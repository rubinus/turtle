	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TurtleTurtle().Ingresses().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TurtleTurtle().Ingresses().Watch(options)
			},
		},
		&apisturtle.Ingress{},
		resyncPeriod,
...
func (f *ingressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisturtle.Ingress{}, f.defaultInformer)
}

func (f *ingressInformer) Lister() turtle.IngressLister {
	return turtle.NewIngressLister(f.Informer().GetIndexer())
}
