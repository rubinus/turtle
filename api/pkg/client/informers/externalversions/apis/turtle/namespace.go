	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TurtleTurtle().Namespaces().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TurtleTurtle().Namespaces().Watch(options)
			},
		},
		&apisturtle.Namespace{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *namespaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisturtle.Namespace{}, f.defaultInformer)
}

func (f *namespaceInformer) Lister() turtle.NamespaceLister {
	return turtle.NewNamespaceLister(f.Informer().GetIndexer())
}
