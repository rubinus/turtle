	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TurtleTurtle().Events().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TurtleTurtle().Events().Watch(options)
			},
		},
		&apisturtle.Event{},
		resyncPeriod,
...
func (f *eventInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisturtle.Event{}, f.defaultInformer)
}

func (f *eventInformer) Lister() turtle.EventLister {
	return turtle.NewEventLister(f.Informer().GetIndexer())
}
